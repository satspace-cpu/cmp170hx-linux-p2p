# CMP 170HX P2P: текущий проверенный путь и исторический mailbox
...
> **Исправление, 2026-09-11:** content-check опроверг прежний результат
> Mailbox B2. Он мог показывать capability и скорость sample, не меняя VRAM
> соседней карты. Единственный путь с проверенным содержимым в этом репозитории
> сейчас — [Static BAR1](STATIC-BAR1-P2P.ru.md). Не используйте mailbox ниже
> как рабочий рецепт P2P.

## Короткое сравнение

| Параметр | Путь A — DEFAULT / mailbox (исторический, опровергнут) | Путь B — Static BAR1 (текущий) |
|---|---|---|
...
| Скорость в одну сторону | исторический sample, недействителен | **5.30 GB/s** Gen2 x16 на этом хосте |
| Bidirectional | исторический sample, недействителен | **10.27 GB/s** на этом хосте |
| GPU latency | исторический sample, недействителен | **1.69–1.71 мкс** на этом хосте |
...
# Путь A — DEFAULT / mailbox (исторический, не применять)
...
# Путь B — Static BAR1 P2P (текущий проверенный путь)
